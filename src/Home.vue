...
<template>
  <section id="home" class="items-center space-y-20">
    ...
    <div class="flex items-center justify-evenly bg-black bg-opacity-20 backdrop-blur md:px-20 py-10 rounded-md w-full">
      ...
      <a href="https://t.me/Gerianooo" target="_blank" title="Telegram" class="w-12 h-12 text-gray-300 rounded p-1">
      ...
      <a href="https://github.com/Geriano" target="_blank" title="Github" class="w-12 h-12 text-gray-300 rounded p-1">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="currentColor">
      ...
      <a href="mailto:gerznewbie@gmail.com" target="_blank" title="Mail" class="w-12 h-12 text-gray-300 rounded p-1">
